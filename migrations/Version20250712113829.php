...
final class Version20250712113829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id SERIAL NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(200) NOT NULL, name VARCHAR(200) NOT NULL, role VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
